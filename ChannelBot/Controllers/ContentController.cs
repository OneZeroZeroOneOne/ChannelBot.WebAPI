...
namespace ChannelBot.Controllers
{
    ...
    public class ContentController : ControllerBase
    {
        ...
        [Authorize(Policy = "AdminRole")]
        [HttpPost]
        public async Task CreateContent([FromQuery] string mediaUrl, [FromQuery] string description, [FromQuery] int sourceId)
        {
            await _contentService.CreateContent(Uri.UnescapeDataString(mediaUrl), Uri.UnescapeDataString(description), sourceId);
